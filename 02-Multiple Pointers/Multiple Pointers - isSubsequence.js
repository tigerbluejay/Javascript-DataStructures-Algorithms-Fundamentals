...
function isSubsequence(str1, str2) {
  ...
  // this line is called if there is no character match
  // shortening the second string and testing in the next iteration
  // against later characters in str2, until a match is found (or none)
  // in which case the entire str2 is sliced and false is returned.
